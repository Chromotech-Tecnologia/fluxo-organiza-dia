      ...
      return (
        <SidebarMenuItem key={item.title}>
          <SidebarMenuButton 
            ...
            isActive={isActive}
            className={isActive ? "bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 text-foreground font-medium border-l-2 border-violet-500 rounded-l-none" : ""}
          >
