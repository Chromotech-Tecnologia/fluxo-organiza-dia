...
export const SignInPage = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-800 to-green-400 relative overflow-hidden">
        {/* Background Pattern */}
          ...
          <div className="max-w-md">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-lg text-white">Gestão inteligente de tarefas</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span className="text-lg text-white">Colaboração em equipe</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span className="text-lg text-white">Relatórios e analytics</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span className="text-lg text-white">Interface intuitiva</span>
              </div>
            </div>
          </div>
        </div>
